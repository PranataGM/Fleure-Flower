    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div class="group bg-white flex flex-col">
                <div class="overflow-hidden aspect-[3/4] img-wrap bg-gray-100 relative">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-stretch">
            <div class="w-full md:w-1/2 img-wrap h-72 md:h-[520px]">
                <img src="https://images.unsplash.com/photo-1572454591674-2739f30d8c40?q=80&w=900" alt="Florist" class="w-full h-full object-cover img-zoom">
            </div>
            <div class="w-full md:w-1/2 px-8 md:px-16 py-14 bg-white flex flex-col justify-center">
